...
Для сборки шаблонов необходим [Node.js](https://nodejs.org/en/) 0.12 или выше.



```bash
git clone https://narmatoff@bitbucket.org/narmatoff/email-templates.git
```

Далее переходим в проект и устанавливаем зависимости:
...
`npm run build` Собрать инлайновый билд для конечного использования.
